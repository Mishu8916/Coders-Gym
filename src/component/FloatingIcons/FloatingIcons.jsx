...
const FloatingIcons = () => {
  ...
  <button
    ...
    className="bg-primary text-white p-4 md:p-5 rounded-full shadow-lg hover:bg-primary/90 transition-all duration-300 flex items-center justify-center group relative"
