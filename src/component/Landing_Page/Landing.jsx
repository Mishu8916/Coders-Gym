  ...
  const swiperData = [
    {
      ...
      slogan: 'Unleash Your',
      title: 'Potential',
      desc: 'Discover the best workouts and nutrition to elevate your fitness journey.',
    },
    {
      id: 2,
      bgImg: con2,
      slogan: 'Train Like A',
      title: 'Champion',
      desc: 'Equip yourself with the tools to perform like a pro.',
    },
    {
      id: 3,
      bgImg: con3,
      slogan: 'Achieve Your',
      title: 'Goals',
      desc: 'Take a step closer to your fitness aspirations with our guidance.',
    },
    {
      id: 4,
      bgImg: con4,
      slogan: 'Stay Active, Stay',
      title: 'Healthy',
      desc: 'Build a healthier lifestyle with our comprehensive programs.',
    },
    {
      id: 5,
      bgImg: con5,
      ...
      title: 'Every Day',
      desc: 'Challenge yourself daily and see incredible results.',
    },
    {
      id:6,
      bgImg: con6,
      slogan: 'Fitness Is Your',
      title: 'Future',
      desc: 'Invest in your body for long-term health and happiness.',
    },
    {
      id: 7,
      bgImg: con7,
      slogan: 'Rise And',
      title: 'Grind',
      desc: 'Start your mornings with an energetic routine.',
    },
  ];
          ...
          <SwiperSlide key={slide.id} className="w-full h-full relative">
            ...
            >
              ...
              <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-center px-4 z-10">
                ...
                <button
                  data-aos="fade-up"
                  className="outline-btn mt-10 text-xl dark:text-white font-serif"
                >
                  TRY FOR FREE
              </button>
              </div>
