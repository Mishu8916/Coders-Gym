...
const skillsData = [
    {
      ...
      price: "899",
      icon: (
        <BiRupee className="text-5xl text-primary group-hover:text-black duration-300" />
      ),
    link: "#",
    description: [
  ...
  },
  {
    ...
    price: 1999,
    icon: (
      <BiRupee className="text-5xl text-primary group-hover:text-black duration-500" />
    ),
    link: "#",
    description: [
      "Monthly access to fitness area.",
